...
Points to a running [GroundFork Antenna](https://github.com/johanneshilden/groundfork-antenna-postgres) service. The endpoint is used for synchronization, when connectivity is available. 
